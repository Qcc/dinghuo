...
class FormalLicenseManager extends React.Component{
    //发放正式授权
    handleAskTempLic(){
    ...
    render(){
        return(
            <div>
                ...
                <h2 style={{display:'inline-block'}}>正式授权管理</h2>
                <Button type="primary" onClick={this.handleAskTempLic} style={{position:"absolute",right:0}}>申请正式授权</Button>
                </div>
                <FilterTable />
...
export default FormalLicenseManager;